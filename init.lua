...
require('lazy').setup({
  ...
  -- Local plugin: claude-agents.nvim
  {
    dir = '/home/jay/claude-agents.nvim',
    name = 'claude-agents.nvim',
    config = function()
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        --
        defaults = {
          file_ignore_patterns = {}, -- Clear default ignore patterns to show hidden files
          -- mappings = {
